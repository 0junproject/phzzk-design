...
## 소통 및 관계 도메인 (Communication & Relation)
* **팔로우 (Follow):** 시청자가 특정 스트리머의 채널을 즐겨찾기하고 방송 시작 알림을 받기로 구독하는 행위 (MVP에서는 결제 기반의 '구독'과 구분하여 무료 알림 수신 목적으로만 사용).
* **팔로워 (Follower):** 특정 스트리머를 팔로우하는 시청자.
* **팔로위 (Followee):** 시청자로부터 팔로우를 받는 스트리머.